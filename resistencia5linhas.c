...
#include <stdlib.h>
void main(){
	double preto = 0, castanho = 1, vermelho = 2, laranja = 3, amarelo = 4, verde = 5, azul = 6, roxo = 7, cizento= 8, branco = 9, ouro = 10, prata = 11, linha1, linha2, linha3, linha4, linha5, total, total2;
	printf("\e[44m###################################################\n");
